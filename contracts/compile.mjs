...
const SOURCES = [
  ...
  "contracts/src/oracle/SignedPriceOracle.sol",
  ...
  "contracts/src/integrations/AaveV3YieldSource.sol",
  "contracts/src/integrations/ERC4626YieldSource.sol",
  "contracts/src/integrations/SushiSwapAdapter.sol",
  "contracts/src/integrations/ZeroExSwapAdapter.sol",
  "contracts/src/integrations/EigenLayerRestakeAdapter.sol",
  "contracts/src/integrations/BridgeAdapter.sol",
  "contracts/src/integrations/PendleYieldTokenizer.sol",
  "contracts/src/integrations/YieldRouter.sol",
  "contracts/src/integrations/RebalanceRouter.sol",
  "contracts/src/mocks/MockOptionsVenue.sol",
  "contracts/src/mocks/MockIntegrations.sol",
